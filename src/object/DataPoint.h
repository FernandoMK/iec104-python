...
namespace Object {
  ...
  private:
    ...
    /// @brief current select/execute command.
    std::atomic_bool selectCommand{false};
  ...
  public:
    ...
    /**
     * @brief Get Select/Execute command
     * @return Select/Execute bit value. false for "Execute", true for "Select"
     */
    bool getSelectCommand() const;
